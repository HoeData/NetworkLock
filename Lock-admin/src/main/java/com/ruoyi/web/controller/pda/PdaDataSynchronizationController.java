...
public class PdaDataSynchronizationController {
    ...
    public AjaxResult getConflictList() {
        Map<String, List<LockPortInfo>> map = new HashMap<>();
        map.put("pcMap", PdaDataSynchronizationUtil.oldPcList);
        map.put("pdaMap", PdaDataSynchronizationUtil.oldPdaList);
        return AjaxResult.success(map);
    }

    @PostMapping("/setConflictList")
    public AjaxResult setConflictList(@RequestBody List<LockPortInfo> portInfoList) {
        PdaDataSynchronizationUtil.oldPcList = portInfoList;
